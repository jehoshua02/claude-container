...
- Value: 5/10 — Nice to have, not blocking anything
- Momentum: 2/10 — Not started
- Effort: 5/10 — ttyd + Tailscale + Cloudflare Tunnel setup, Docker Compose changes
- Risk: 5/10 — Exposing a terminal publicly has real consequences if misconfigured
